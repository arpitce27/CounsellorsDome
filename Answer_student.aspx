<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="Answer_student.aspx.cs" Inherits="Interest_assessment" %>
      ...
      <div>
        ...
        <table style="width:98%; height: 93px;" align="center">
            ...
            <tr>
                ...
                <td class="style3">
                    <textarea class="form-control" id="txt_question" runat="server" rows="2"></textarea></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="style4">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="btn_submit" runat="server" Font-Size="Large" Height="39px" 
                        onclick="btn_submit_Click" Text="Submit answer" cssclass="btn btn-default" Width="229px" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="btn_goback" runat="server" Font-Size="Large" Height="38px" 
                        onclick="btn_goback_Click" Text="Go back to questions" cssclass="btn btn-default" Width="241px" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
