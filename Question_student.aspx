<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Question_student.aspx.cs" Inherits="Interest_assessment" %>
    ...
    <div>
      ...
      <nav>
        <ul class="menu">
          ...
          <li class="current"><a href="Question_student.aspx">Query</a></li>
...
<div class="grid_12 box-2">
      <div>
        <p class="text-3">Your<span> Problem</span> may be solve here!</p>
        ...
        <table style="width:98%; height: 93px;" align="center">
            ...
            <tr>
                <td colspan="4">Add your Questions here!</td>
            </tr>
            <tr>
                <td class="style4">&nbsp;</td>
                <td class="style2">&nbsp;</td>
            ...
            <tr>
                <td class="style4">&nbsp;</td>
                <td class="style2">
                    <asp:Label ID="Label2" runat="server" Text="Questions"></asp:Label>
                </td>
                <td class="style3">
                    <textarea id="txt_question" runat="server" cols="20" name="S1" rows="2"></textarea></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="style4">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="btn_submit" runat="server" Font-Size="Large" Height="39px" 
                        onclick="btn_submit_Click" Text="Submit question" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
